...
function showSubmitMessage(form: HTMLFormElement, type: "success" | "error", message: string): void {
  clearSubmitMessage();
...
function clearSubmitMessage(): void {
 ...
 * @param form
 */
async function submitQuoteData(data: QuoteFormData, form: HTMLFormElement): Promise<void> {
  try {
